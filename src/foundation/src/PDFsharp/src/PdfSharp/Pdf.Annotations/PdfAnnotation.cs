...
namespace PdfSharp.Pdf.Annotations
{
    ...
    public abstract class PdfAnnotation : PdfDictionary
    {
        ...
        /// <summary>
        /// Gets or sets the text label to be displayed in the title bar of the annotationís
        ...
        public class Keys : KeysBase
        {
            ...
            /// regenerates the annotationís appearance stream, it may incorporate the CA value
            /// into the streamís content.)
